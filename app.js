...
var stacked1 = function(filepath){
    ...
    data.then(function(data){
        ...
        q4.append("rect").attr("x", 120).attr("y", 105).attr('width', 8).attr('height', 8).style("fill", "rgb(104, 179, 163)")
        q4.append("rect").attr("x", 120).attr("y", 125).attr('width', 8).attr('height', 8).style("fill", "rgb(135, 175, 230)")
        q4.append("rect").attr("x", 120).attr("y", 145).attr('width', 8).attr('height', 8).style("fill", "rgb(230, 130, 130)")
...
var stacked2 = function(filepath){
    ...
    data.then(function(data){
        ...
        q4.append("rect").attr("x", 120).attr("y", 205).attr('width', 8).attr('height', 8).style("fill", "rgb(250, 180, 90)")
        q4.append("rect").attr("x", 120).attr("y", 185).attr('width', 8).attr('height', 8).style("fill", "rgb(135, 175, 230)")
        q4.append("rect").attr("x", 120).attr("y", 165).attr('width', 8).attr('height', 8).style("fill", "rgb(230, 130, 130)")
        q4.append("rect").attr("x", 120).attr("y", 145).attr('width', 8).attr('height', 8).style("fill", "rgb(250, 215, 115)")
        q4.append("rect").attr("x", 120).attr("y", 125).attr('width', 8).attr('height', 8).style("fill", "rgb(200, 115, 250)")
        q4.append("rect").attr("x", 120).attr("y", 105).attr('width', 8).attr('height', 8).style("fill", "rgb(104, 179, 163)")
...
var stream = function(filepath){
    ...
    csv.then(function(data){
        ...
        svg.append("rect").attr("x", 120).attr("y", 85).attr('width', 8).attr('height', 8).style("fill", "rgb(135, 175, 230)")
        svg.append("rect").attr("x", 120).attr("y", 105).attr('width', 8).attr('height', 8).style("fill", "rgb(104, 179, 163)")
        svg.append("rect").attr("x", 120).attr("y", 125).attr('width', 8).attr('height', 8).style("fill", "rgb(230, 130, 130)")
